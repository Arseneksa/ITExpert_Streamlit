...
# from views.spacialData.spacial_country import spacial_country
# from views.spacialData.spacial_site import spacial_site
# from views.spacialData.spacial_landscape import spacial_landscape
from views.spacialData.spacial_region import spacial_region
#######################
# Plots
...
def spacialData():
    ...
    dataurl =onlineurl+"/api/spacialAndLandcover"
    ...
    df = pd.json_normalize(data_dict["spacial"])
    # st.write(df)
    ...
    if selected_level =="Country":
        ...
        # spacial_country(st,selected_country,data,pd)
    if selected_level =="Landscape":
        ...
        # spacial_landscape(st,selected_landscape,data,pd)
    if selected_level =="Site":
        ...
        # spacial_site(st,selected_site,data,pd)
