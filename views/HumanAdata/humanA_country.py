...
def humanA_country(st,country,data,pd):
    ...
    with tab2:
        ...
        #         chart_cumulative_area_covered = altairLineChart(alt,cumulative_country_area_covered_df,selected_effort_indicator,country     .capitalize()+" cumulative area covered",480)
